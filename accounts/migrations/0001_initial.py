    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('PATIENT', 'Patient'), ('DOCTOR', 'Doctor'), ('LAB_TECH', 'Lab Technician'), ('RECEPTIONIST', 'Receptionist'), ('ADMIN', 'Admin')], default='PATIENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_days', models.CharField(help_text='e.g., Mon,Tue,Wed', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lab_tech', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
